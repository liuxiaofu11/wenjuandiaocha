...
(
    ...
    `user_info`   TEXT                                                                   DEFAULT NULL COMMENT '平台用户信息',
    `create_time` datetime                                                      NOT NULL DEFAULT CURRENT_TIMESTAMP,
    `update_time` datetime                                                      NOT NULL DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY (`id`) USING BTREE,
...
(
    ...
    `scheme`      TEXT                                                                  DEFAULT NULL COMMENT '模板定义',
...
(
    ...
    `user_id_list`  TEXT     DEFAULT NULL COMMENT '用户Id列表',
    `role_id_list`  TEXT     DEFAULT NULL COMMENT '角色Id列表',
    `dept_id_list`  TEXT     DEFAULT NULL COMMENT '部门Id列表',
    `update_time`   datetime DEFAULT CURRENT_TIMESTAMP COMMENT '更新时间',
    `create_time`   datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
    PRIMARY KEY (`id`) USING BTREE,
...
(
    ...
    `original_data`     TEXT                                                          DEFAULT NULL COMMENT '填写结果',
    `submit_ua`         TEXT                                                          DEFAULT NULL COMMENT '提交ua',
    ...
    `wx_user_info`      TEXT                                                          DEFAULT NULL COMMENT '微信用户信息',
...
(
    ...
    `scheme`          TEXT                                                                   DEFAULT NULL COMMENT '表表单原始JSON',
    `reg_list`        TEXT                                                                   DEFAULT NULL COMMENT '正则表达式 ',
    `update_time`     datetime                                                               DEFAULT CURRENT_TIMESTAMP COMMENT '更新时间',
    `create_time`     datetime                                                               DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
    PRIMARY KEY (`id`) USING BTREE,
    KEY               `project_key` (`form_key`) USING BTREE
...
(
    ...
    `form_key`    varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '表单key',
    `scheme`      TEXT     DEFAULT NULL COMMENT '逻辑定义',
    `create_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
    `update_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '更新时间',
    PRIMARY KEY (`id`) USING BTREE,
...
(
    `id`          bigint                                                        NOT NULL AUTO_INCREMENT,
    `form_key`    varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '表单key',
    `settings`    TEXT     DEFAULT NULL COMMENT '设置内容 ',
    `update_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '更新时间',
    `create_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
    PRIMARY KEY (`id`) USING BTREE,
    UNIQUE KEY `project_key` (`form_key`) USING BTREE
...
(
    ...
    `env_value`   TEXT                                                          NOT NULL COMMENT '参数键值',
